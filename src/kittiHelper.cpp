...
int main(int argc, char** argv)
{
    ...
    ros::Publisher pub_laser_cloud = n.advertise<sensor_msgs::PointCloud2>("/os1_cloud_node/points", 2);
    ...
    while (std::getline(timestamp_file, line) && ros::ok())
    {
        ...
        if (to_bag)
        {
            ...
            bag_out.write("/os1_cloud_node/points", ros::Time::now(), laser_cloud_msg);
